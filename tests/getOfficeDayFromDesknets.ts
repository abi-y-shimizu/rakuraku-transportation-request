...
const DESKNETS_REMOTE_TITLE = process.env.DESKNETS_REMOTE_TITLE as string;
const DESKNETS_VACATION_TITLE = process.env.DESKNETS_VACATION_TITLE as string;


export async function getOfficeDayFromDesknets({ page }) {
    /*
    ...
    */
    try{
        ...
        // Setだと重複しない
        const officeDateSet = new Set<string>();
        const remoteDateSet = new Set<string>();
...
function extractDateRange(year: string, text: string) {
